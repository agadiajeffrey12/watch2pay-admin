...
import { useCreateVideoCategory } from '@/hooks/useVideoCategory';
...
const CategoriesPage = () => {
  ...
  const CategoryForm: React.FC<CategoryFormProps> = ({ onSubmit, submitText }) => (
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      >
        <CategoryForm onSubmit={handleCreateCategory} submitText="Create Category" />
      </Modal>
      ...
      <Modal
        ...
        title="Edit Category"
      >
        <CategoryForm onSubmit={handleEditCategory} submitText="Update Category" />
      </Modal>
