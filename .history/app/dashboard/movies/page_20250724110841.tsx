...
const MoviesPage = () => {
  ...
  const MovieImage = ({ src, alt, className, width, height }: { 
    src: string, 
    alt: string, 
    className: string,
    width?: number,
    ...
    const handleImageError = () => {
      ...
      setImageSrc('/api/placeholder/400/600'); // You can replace this with your placeholder
    };
    ...
    return (
      <Image
        ...
        unoptimized={true} // Use this if you're having issues with Vercel image optimization
        priority={false}
      />
    );
  };
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredMovies.map((movie) => (
              <tr key={movie._id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{(movie as any)?.year || "2004"}</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center gap-1">
