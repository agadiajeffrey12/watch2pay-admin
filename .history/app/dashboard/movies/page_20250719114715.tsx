  ...
  const renderGridView = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {filteredMovies.map((movie) => (
        <div key={movie._id} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow">
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-2 mb-3">
              <span className="text-sm text-gray-600">{movie?.year || "2004"}</span>
